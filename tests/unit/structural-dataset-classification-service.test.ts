  ...
  it("ranks repeated primary-content records above repeated navigation", async () => {
    const result: DiscoveryResult = {
      ...
      pages: [
        ...
        { url: "https://books.example/category/fiction", canonicalUrl: "https://books.example/category/fiction", depth: 1, parentUrl: "https://books.example/", links: [], title: "Fiction", contentType: "text/html", disposition: "captured", structure: { mainRecordCandidates: 0, mainLinkCount: 0, navigationLinkCount: 12, paginationLinkCount: 0, mainHeading: "Fiction" } },
        { url: "https://books.example/category/history", canonicalUrl: "https://books.example/category/history", depth: 1, parentUrl: "https://books.example/", links: [], title: "History", contentType: "text/html", disposition: "captured", structure: { mainRecordCandidates: 0, mainLinkCount: 0, navigationLinkCount: 12, paginationLinkCount: 0, mainHeading: "History" } }
      ]
    };
